...
{
    public abstract class BaseSerializerContext : ISerializerContext
    {

        protected BaseSerializerContext(GeneratorsSettings settings)
        {
            Settings = settings;
        }


        protected GeneratorsSettings Settings { get; init; }
