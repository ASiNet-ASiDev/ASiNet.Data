...
internal class AutoGeneratedModel<T> : SerializeModel<T>, IDisposable
{
    ...
    public override void Serialize(T obj, in ISerializeWriter writer, ISerializerContext context)
    {
        if (_serializeDelegate is null)
            throw new NullReferenceException();
    ...
    public override T Deserialize(in ISerializeReader reader, ISerializerContext context)
    {
        if (_deserializeDelegate is null)
            throw new NullReferenceException();
        return _deserializeDelegate(reader);
    ...
    public override int ObjectSerializedSize(object obj, ISerializerContext context) =>
        ObjectSerializedSize((T)obj, context);

    public override int ObjectSerializedSize(T obj, ISerializerContext context)
    {
